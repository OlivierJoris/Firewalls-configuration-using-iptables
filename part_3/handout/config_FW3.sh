...
# 14. input deny
iptables -A FORWARD -d 10.10.3.0/24 -j LOG --log-prefix "fw3 - block in z-nfs"
iptables -A FORWARD -d 10.10.3.0/24 -j DROP

## Outgoing traffic z-nfs 

# 15. output deny
iptables -A FORWARD -s 10.10.3.0/24 -j LOG --log-prefix "fw3 - block out z-nfs"
...
# 17. input deny
iptables -A FORWARD -d 192.168.3.0/24 -j LOG --log-prefix "fw3 - block in z-u3"
...
# 20.input deny
iptables -A FORWARD -d 10.10.4.0/24 -j LOG --log-prefix "fw3 - block in z-ssh"
iptables -A FORWARD -d 10.10.4.0/24 -j DROP

## Outgoing traffic z-ssh

# 21. output deny
iptables -A FORWARD -s 10.10.4.0/24 -j LOG --log-prefix "fw3 - block out z-ssh"
