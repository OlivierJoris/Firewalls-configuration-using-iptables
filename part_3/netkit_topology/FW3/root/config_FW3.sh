...
iptables -A FORWARD -s 192.168.3.2 -d 10.10.3.2 -p tcp --dport 111 -j ACCEPT
# 2. HONEYPOT to NFS (portmapper)
iptables -A FORWARD -s 192.168.3.2 -d 10.10.3.2 -p udp --dport 111 -j ACCEPT
# 3. HONEYPOT to NFS (status)
iptables -A FORWARD -s 192.168.3.2 -d 10.10.3.2 -p tcp --dport 2046 -j ACCEPT
# 4. HONEYPOT to NFS (status)
iptables -A FORWARD -s 192.168.3.2 -d 10.10.3.2 -p udp --dport 2046 -j ACCEPT
# 5. HONEYPOT to NFS (nlockmgr)
iptables -A FORWARD -s 192.168.3.2 -d 10.10.3.2 -p tcp --dport 2047 -j ACCEPT
# 6. HONEYPOT to NFS (nlockmgr)
iptables -A FORWARD -s 192.168.3.2 -d 10.10.3.2 -p udp --dport 2047 -j ACCEPT
# 7. HONEYPOT to NFS (mountd)
iptables -A FORWARD -s 192.168.3.2 -d 10.10.3.2 -p tcp --dport 2048 -j ACCEPT
# 8. HONEYPOT to NFS (mountd)
iptables -A FORWARD -s 192.168.3.2 -d 10.10.3.2 -p udp --dport 2048 -j ACCEPT
# 9. HONEYPOT to NFS
iptables -A FORWARD -s 192.168.3.2 -d 10.10.3.2 -p tcp --dport 2049 -j ACCEPT
# 10. HONEYPOT to NFS
iptables -A FORWARD -s 192.168.3.2 -d 10.10.3.2 -p udp --dport 2049 -j ACCEPT
# 11. U3 to RSYNC
...
# 18. U3 to SSH
iptables -A FORWARD -s 192.168.3.3 -d 192.168.3.0/24 -p tcp --dport 22 -j DROP
# 19. output deny
